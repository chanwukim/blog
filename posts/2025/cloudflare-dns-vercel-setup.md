...
description: "Cloudflare DNS와 Vercel 배포 앱을 연결하고 발생할 수 있는 리디렉션 문제를 해결하는 방법"
category: "DevOps"
tags:
  - Vercel
  - Cloudflare
...
![Vercel 도메인 등록](/images/cloudflare-dns-vercel-setup/01.png)
...
2. SSL/TLS 암호화의 "설정"을 누른다.
   ![Cloudflare SSL/TLS 설정 진입](/images/cloudflare-dns-vercel-setup/02.png)
3. "사용자 지정 SSL/TLS"의 "전체"로 변경한다.
   ![Cloudflare SSL/TLS 설정](/images/cloudflare-dns-vercel-setup/03.png)
