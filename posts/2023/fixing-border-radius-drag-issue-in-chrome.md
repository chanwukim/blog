...
description: "드래그 중인 고스트 이미지에 border-radius가 먹히지 않을 때"
category: "CSS"
tags:
  - CSS
  - FE
...
> Mac OS 크롬
> <img alt="크롬" src="/images/fixing-border-radius-drag-issue-in-chrome/01.png" width="50%" />

> Mac OS 파이어폭스
> <img alt="파이어폭스" src="/images/fixing-border-radius-drag-issue-in-chrome/02.png" width="50%" />
